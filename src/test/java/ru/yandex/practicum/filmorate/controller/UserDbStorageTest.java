...
public class UserDbStorageTest {
    ...
    public void addFriendTest() {
        ...
        List<User> friends = userDbStorage.getFriends(user1.getId()).stream().toList();
    ...
    public void commonFriendsTest() {
        ...
        List<User> friends1 = userDbStorage.getFriends(user1.getId()).stream().toList();
        Set<Integer> list1 = friends1.stream().map(User::getId).collect(Collectors.toCollection(HashSet::new));

        List<User> friends2 = userDbStorage.getFriends(user2.getId()).stream().toList();
